...
namespace Softtek.Academy2018.ToDoListApp.WebAPI.Controllers
{
    ...
    public class ItemController : ApiController
    {
        ...
        [Route("{id:int}")]
        [HttpPut]
        public IHttpActionResult Update([FromBody] ItemDTO itemDTO, [FromUri] int id)
        {
            if (itemDTO == null) return BadRequest("Request is null");
            ...
            if (!result) return BadRequest("Unable to update task");
        ...
        public IHttpActionResult GetById([FromUri] int id)
        {
            ...
            if (result == null) return BadRequest("Task not found");
